...
public class WaveManagerScript : MonoBehaviour
{
    ...
    private struct Enemy
    {
        ...
        [HideInInspector]
        public float lifeMultiplier, damageMultiplier, speedMultiplier, probability;
    ...
    private void SpawnEnemy(Enemy enemyPicked)
    {
        ...
        if (enemy != null)
        {
            ...
            //enemy.GetComponent<EnemyScript>().UpdateStats();
        }
    ...
    private void EndWave()
    {
        ...
        else Debug.LogWarning("Unfinished Script - win game");
